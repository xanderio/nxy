...
let
  nixifiedLockHash = "91fe772b96f750e44c4cf709849359b554c4dbeaab3d3a128c262a93849dcbae";
...
in
{
  ...
  workspace = {
    agent = rustPackages.unknown.agent."0.1.0";
  ...
  "unknown".agent."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "agent";
    version = "0.1.0";
    registry = "unknown";
